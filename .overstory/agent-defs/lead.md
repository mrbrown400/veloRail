...
## velorail-role-guidance

If your assigned Seeds issue has a `role/...` label, read the matching `agents/<role>.md` file before decomposing work or writing builder instructions. These VeloRail roles are domain guidance only; spawn standard Overstory capabilities for implementation and review.
